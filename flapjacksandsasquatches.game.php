...
class FlapjacksAndSasquatches extends Table
{
    ...
    */
    ...
    public function actPlayCard(int $card_id)
    {
        ...
        if (isset($card_def["targeted"]) && $card_def["targeted"] == true) {
    ...
    function actPlayReaction(int $card_id)
    {
        ...
        if (!isset($card_def["can_react"]) || !$card_def["can_react"]) {
            throw new BgaUserException(
    ...
    */
    ...
    function argSelectTarget()
    {
        ...
        // All cards can be played on self or others
        foreach ($players as $player_id => $player) {
    ...
    */
    ...
    function stDrawTreeCard()
    {
        ...
        if ($tree_card) {
            // Get tree info
            $tree_info = $this->tree_cards[$tree_card["type_arg"]];
    ...
    function stChoppingRoll()
    {
        ...
        foreach ($equipment as $equip) {
            if (
                strpos($equip["equipment_type"], "axe") !== false ||
